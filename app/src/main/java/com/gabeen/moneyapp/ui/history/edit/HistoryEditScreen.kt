...
import com.gabeen.moneyapp.ui.components.BasicButton
import com.gabeen.moneyapp.ui.components.BasicDateEditBar
import com.gabeen.moneyapp.ui.components.BasicEditBar
import com.gabeen.moneyapp.ui.components.BasicNumberEditBar
import com.gabeen.moneyapp.ui.components.BasicTimeEditBar
import com.gabeen.moneyapp.ui.components.BasicTopBar
import com.gabeen.moneyapp.ui.components.BlockTouchOverlay
import com.gabeen.moneyapp.ui.components.DeleteButtonSearchEditBar
import com.gabeen.moneyapp.ui.history.HistoryViewModel
import com.gabeen.moneyapp.ui.history.add.CategoryBottomSheetContent
import com.gabeen.moneyapp.ui.history.add.EditTypeBar
import com.gabeen.moneyapp.ui.history.add.HistoryField
    ...
    Scaffold(
        topBar = {
            BasicTopBar(
                ...
                onClickNavIcon = {
                    isClosing = true
                    onEvent(HistoryEditEvent.ClickedBack)
                }
            )
        }
    ) { paddingValues ->
...
private fun HistoryEditContent(historyEditState: HistoryEditState, onEvent: (HistoryEditEvent) -> Unit) {
    ...
    Column(
        ...
        BasicNumberEditBar(
            name = "금액",
            value = if (historyEditState.inputData.transaction.amount == 0L) "" else historyEditState.inputData.transaction.amount.toString(),
